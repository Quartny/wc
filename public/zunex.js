(function (window, document) {
  ...
  function addStyles() {
    ...
    style.textContent += '.zunex-modal{background:rgb(168,156,242);color:#171426}.zunex-modal h2{color:#171426}.zunex-subtitle{color:#514b70}.zunex-close{border-color:rgba(23,20,38,.22);background:rgba(255,255,255,.24);color:#171426}.zunex-wallet{border-color:rgba(23,20,38,.18);background:rgba(255,255,255,.22);color:#171426}.zunex-wallet-info small{color:#514b70}.zunex-empty{border-color:rgba(23,20,38,.25);color:#514b70}.zunex-empty strong{color:#171426}.zunex-error{color:#8d2f3c}.zunex-wallet-icon{background:rgba(23,20,38,.16)}.zunex-wallet-icon.zunex-inbuild{background:#83d8d0}@media(max-width:480px){.zunex-modal{background:rgb(168,156,242)}}';
