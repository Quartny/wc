(function (window, document) {
  ...
  function addStyles() {
    ...
    style.textContent += '.zunex-backdrop{overflow-y:auto;padding:clamp(14px,4vw,32px);background:rgba(0,0,0,.28);backdrop-filter:blur(22px) saturate(125%);-webkit-backdrop-filter:blur(22px) saturate(125%)}.zunex-modal{width:min(100%,420px);max-height:calc(100dvh - 2 * clamp(14px,4vw,32px));overflow-y:auto;padding:clamp(20px,4vw,30px);border-color:rgba(255,255,255,.18);background:linear-gradient(145deg,rgba(22,27,38,.86),rgba(7,10,16,.78));box-shadow:0 24px 80px rgba(0,0,0,.42),inset 0 1px 0 rgba(255,255,255,.1);backdrop-filter:blur(28px) saturate(135%);-webkit-backdrop-filter:blur(28px) saturate(135%)}.zunex-wallet-list{width:calc(100% - 18px);margin-inline:auto}.zunex-wallet-list[hidden],.zunex-loading[hidden]{display:none!important}.zunex-wallet{padding:12px 13px;background:rgba(255,255,255,.045);border-color:rgba(255,255,255,.1)}.zunex-wallet-icon{width:36px;height:36px;flex-basis:36px}.zunex-wallet-info{min-width:0}.zunex-wallet-info strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.zunex-wallet:focus,.zunex-wallet:focus-visible,.zunex-close:focus,.zunex-close:focus-visible,.zunex-icon-action:focus,.zunex-icon-action:focus-visible{outline:none;box-shadow:none}.zunex-loading{display:grid;min-height:180px;place-items:center;color:#83d8d0}.zunex-loading svg{width:42px;height:42px}@media(max-width:480px){.zunex-backdrop{align-items:center;padding:12px}.zunex-modal{max-height:calc(100dvh - 24px);border-radius:15px}.zunex-wallet-list{width:100%}.zunex-wallet{gap:10px;padding:11px}.zunex-subtitle{margin-bottom:18px}}';
  ...
  function mount(options) {
    ...
    function connect(uuid) {
      ...
      var walletList = modalRoot.querySelector('.zunex-wallet-list');
      var loading = modalRoot.querySelector('[data-loading]');
