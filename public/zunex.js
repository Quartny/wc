(function (window, document) {
  ...
  function addStyles() {
    ...
    style.textContent += '.zunex-backdrop{padding:16px}.zunex-modal{width:min(100%,410px);max-height:calc(100dvh - 32px);overflow:auto;padding:22px;background:linear-gradient(to right,rgb(168,156,242) 0%,rgb(146,134,210) 25%,rgb(114,105,162) 40%,rgb(85,78,120) 60%,rgb(55,51,78) 80%,rgb(28,26,39) 100%)}.zunex-modal-head{gap:16px}.zunex-modal h2{font-size:25px}.zunex-subtitle{margin:8px 0 18px}.zunex-wallet-list{gap:7px}.zunex-wallet{width:calc(100% - 8px);margin:0 4px;padding:11px 12px}.zunex-wallet-icon{width:35px;height:35px;flex-basis:35px}.zunex-wallet-info strong{font-size:12px}.zunex-close{flex:0 0 30px;width:30px;height:30px}.zunex-error{margin:10px 0 0}@media(max-width:480px){.zunex-backdrop{padding:12px}.zunex-modal{width:min(100%,360px);max-height:calc(100dvh - 24px);padding:18px}.zunex-modal h2{font-size:22px}.zunex-wallet{width:calc(100% - 4px);margin:0 2px;padding:10px}.zunex-wallet-icon{width:33px;height:33px;flex-basis:33px}}';
